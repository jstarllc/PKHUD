This is a fork of [Philip Kluz](https://github.com/pkluz)'s `PKHUD`, updated to be half the size of the original HUDs. Please, refer to the [original repo](https://github.com/pkluz/PKHUD) for any questions.
